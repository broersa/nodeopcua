...
(async ()=>{
               ...
               const server = new OPCUAServer({
                   ...
                   buildInfo : {
                     ...
                     buildDate: new Date(2014,5,2)
                              ...
                              nodeset_filename: [nodesets.standard, nodesets.di, "mfstraatman.xml"]
               });
    ...
    const mytype = namespace.findObjectType("LoraSwitchBoxType");
               //const mytypeid = mytype.nodeId;
               ...
               namespace.addObject({componentOf: device, browseName: "myTypeInstance", typeDefinition: mytype});
